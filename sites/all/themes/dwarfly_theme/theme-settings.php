 ...
 *   The form state.
 */
function dwarfly_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','dwarfly_theme'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'dwarfly_theme'),
  ...
  $form['prof_settings']['top_social_link']['twitter_username'] = array(
    ...
    '#default_value' => theme_get_setting('twitter_username', 'dwarfly_theme'),
  ...
  $form['prof_settings']['top_social_link']['facebook_username'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_username', 'dwarfly_theme'),
